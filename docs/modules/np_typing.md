...
Assigning the (platform-dependent) precisions of certain number subclasses, including the likes of int\_, intp and longlong. See the documentation on scalar types for a comprehensive overview of the affected classes. Without the plugin the precision of all relevant classes will be inferred as Any.
...
if TYPE_CHECKING:
reveal_locals() # note: Revealed local types are: # note: a: numpy.floating[numpy.typing._16Bit*] # note: b: numpy.signedinteger[numpy.typing._64Bit*] # note: out: numpy.floating[numpy.typing._64Bit*]
