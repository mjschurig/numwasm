/* ../reference/netlib/ode.f -- translated by f2c (version 20240504).
	...
	nornd)
{
    ...
    integer i__, j, l;
    doublereal r__;
    integer iq, im1, km1, km2, ip1, kp1, kp2;
    doublereal erk, err, tau, rho, sum;
    integer nsm2, nsp1, nsp2;
    doublereal absh, hnew;
    integer knew;
    doublereal xold, twou, erkm1, erkm2, erkp1, temp1, temp2, temp3, temp4, 
	    temp5, temp6, p5eps;
    integer ifail;
