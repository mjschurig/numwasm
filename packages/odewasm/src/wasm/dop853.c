/* /workspace/packages/odewasm/reference/nonstiff/nonstiff/dop853.f -- translated by f2c (version 20240504).
	...
	integer *idid)
{
    ...
    integer iek1, iek2, iek3, iek4, iek5, iek6, iek7, iek8, iek9, iey1, iek10;
    ...
    integer icomp;
    logical arret;
    integer nstep, naccpt, nrejct, nstiff, nrdens, iprint, istore;
    doublereal uround;
...
/*         SMALL CORRECTIONS ON MARCH 4, 2002 */
	...
	integer *naccpt, integer *nrejct)
{
    ...
    /* Local variables */
    integer i__, j;
    doublereal xph, err, sk, fac, err2, fac11, deno;
    integer iord;
    logical last;
    doublereal erri, hnew, bspl, facc1, facc2, expo1, hlamb, ydiff, atoli;
    integer iasti;
    extern doublereal hinit8_(integer *, S_fp, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
...
/* --- INITIAL PREPARATIONS */
    ...
    *hmax = abs(*hmax);
    iord = 8;
    if (*h__ == 0.) {
	*h__ = hinit8_(n, (S_fp)fcn, x, &y[1], xend, &posneg, &k1[1], &k2[1], &
...
doublereal hinit8_(integer *n, S_fp fcn, doublereal *x, doublereal *y, 
