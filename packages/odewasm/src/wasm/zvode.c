/* ../reference/netlib/zvode.f -- translated by f2c (version 20240504).
	...
	integer *ipar)
{
    ...
    integer lf0;
    doublereal big;
    integer mfa, jco, ier, kgo;
    char msg[80];
    doublereal hmx;
    integer lenj;
    logical ihit;
    doublereal ewti, hmax, size;
    integer lenp, mband, iflag;
    doublereal atoli;
    integer leniw, niter, lenwm, imxer;
    doublereal tcrit, tolsf, rtoli;
    integer lenrw;
...
L500:
    s_copy(msg, "ZVODE--  At current T (=R1), MXSTEP (=I1) steps   ", (ftnlen)
	    80, (ftnlen)50);
    xerrwd_(msg, &c__50, &c__201, &c__1, &c__0, &c__0, &c__0, &c__0, &zero, &
	    zero, (ftnlen)80);
    s_copy(msg, "      taken on this call before reaching TOUT     ", (ftnlen)
	    80, (ftnlen)50);
    xerrwd_(msg, &c__50, &c__201, &c__1, &c__1, &zvod01_1.mxstep, &c__0, &
	    c__1, &zvod01_1.tn, &zero, (ftnlen)80);
    *istate = -1;
    goto L580;
	...
	niter, integer *ier)
{
    ...
    integer iter;
    doublereal delyi, atoli, tdist, yddnrm, tround;
    extern doublereal zvnorm_(integer *, doublecomplex *, doublereal *);
	...
	real *rpar, integer *ipar)
{
    ...
    integer ier, jok;
    doublecomplex yjj;
    integer meb1, lenp, mband;
    extern /* Subroutine */ int zgbfa_(doublecomplex *, integer *, integer *, 
	    integer *, integer *, integer *, integer *), zgefa_(doublecomplex 
	    *, integer *, integer *, integer *, integer *), zcopy_(integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *);
    integer meband;
    extern /* Subroutine */ int dzscal_(integer *, doublereal *, 
	    doublecomplex *, integer *), zacopy_(integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *);
    extern doublereal zvnorm_(integer *, doublecomplex *, doublereal *);
...
/* L250: */
	...
	++zvod02_1.nlu;
	zgefa_(&wm[1], &zvod01_1.n, &zvod01_1.n, &iwm[31], &ier);
	if (ier != 0) {
	    *ierpj = 1;
	}
	return 0;
...
/* L580: */
    ...
    ++zvod02_1.nlu;
    zgbfa_(&wm[1], &meband, &zvod01_1.n, &ml, &mu, &iwm[31], &ier);
    if (ier != 0) {
	*ierpj = 1;
    }
    return 0;
	 ...
	 integer *iersl)
{
    ...
    integer ml, mu;
    doublereal phrl1;
    extern /* Subroutine */ int zgbsl_(doublecomplex *, integer *, integer *, 
	    integer *, integer *, integer *, doublecomplex *, integer *), 
	    zgesl_(doublecomplex *, integer *, integer *, integer *, 
	    doublecomplex *, integer *);
    integer meband;
...
L100:
    zgesl_(&wm[1], &zvod01_1.n, &zvod01_1.n, &iwm[31], &x[1], &c__0);
    return 0;
...
L400:
    ...
    mu = iwm[2];
    meband = (ml << 1) + mu + 1;
    zgbsl_(&wm[1], &meband, &zvod01_1.n, &ml, &mu, &iwm[31], &x[1], &c__0);
    return 0;
	...
	doublereal *r1, doublereal *r2, ftnlen msg_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___238 = { 0, 0, 0, fmt_10, 0 };
