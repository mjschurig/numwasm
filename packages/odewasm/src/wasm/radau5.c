/* /workspace/packages/odewasm/reference/stiff/stiff/radau5.f -- translated by f2c (version 20240504).
	...
	idid)
{
    ...
    /* Local variables */
    integer i__, m1, m2, nm1, nit, iee1, ief1, lde1, ief2, ief3, iey0, iez1, 
	    iez2, iez3;
    doublereal facl;
    integer ndec, njac;
    doublereal facr, safe;
    integer ijob, nfcn;
    logical pred;
    doublereal hmax;
    integer nmax;
    doublereal thet, expm;
    integer nsol;
    doublereal quot;
    integer iee2i, iee2r, ieip1, ieip2, nind1, nind2, nind3;
    doublereal quot1, quot2;
    integer iejac, ldjac;
    logical jband;
    integer iecon, iemas, ldmas, ieiph;
    logical arret;
    doublereal fnewt;
    integer nstep;
    doublereal tolst;
    integer ldmas2, iescal, naccpt;
	...
	integer *ndec, integer *nsol, doublereal *rpar, integer *ipar)
{
    ...
    /* Local variables */
    integer i__, j, k, l;
    doublereal a1, a2, c1, c2, a3;
    integer j1, n2, n3;
    doublereal u1, ak;
    integer md;
    doublereal t11, t12, t13, t21, t22, t23, t31;
    integer mm;
    doublereal qt, dd1, dd2, dd3, ak1, ak2, ak3, f1i, f2i, f3i, c1q, c2q, c3q,
	     z1i, z2i, z3i, sq6, fac, ti11, cno;
    integer lrc;
    doublereal ti12, ti13, ti21, ti22, ti23, ti31, ti32, ti33;
    integer ier;
    doublereal xph, thq, err, fac1, cfac, hacc, c1mc2, beta;
    integer lbeg;
    doublereal alph, hold;
    integer lend;
    doublereal delt, hnew;
    logical last;
    doublereal hopt, xold;
    integer newt;
    doublereal dyno, dyth, quot, hhfac, betan, alphn, denom, theta, ysafe, 
	    hmaxn;
    integer nsing;
    logical first;
    integer irtrn, nrsol, nsolu;
    doublereal qnewt, xosol, acont3;
    logical index1, index2, index3, caljac;
    doublereal faccon;
...
/* Computing MIN */
	...
	*h__ = *xend - *x;
	...
	nsolu = *n;
	conra5_1.hsol = hold;
	(*solout)(&nrsol, &xosol, &conra5_1.xsol, &y[1], &cont[1], &lrc, &
		nsolu, &rpar[1], &ipar[1], &irtrn);
	if (irtrn < 0) {
	    goto L179;
	}
    }
