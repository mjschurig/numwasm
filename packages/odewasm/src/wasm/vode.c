/* ../reference/netlib/vode.f -- translated by f2c (version 20240504).
	...
	mf, doublereal *rpar, integer *ipar)
{
    ...
    extern /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    integer niter, lenwm, imxer;
    doublereal tcrit, tolsf;
    integer lenrw;
...
L500:
    s_copy(msg, "DVODE--  At current T (=R1), MXSTEP (=I1) steps   ", (ftnlen)
	    80, (ftnlen)50);
...
/* ----------------------------------------------------------------------- */
    ...
    *iflag = 0;
    ...
    d__1 = abs(dvod01_1.tn) + abs(dvod02_1.hu);
    tfuzz = hun * dvod01_1.uround * d_sign(&d__1, &dvod02_1.hu);
	...
	integer *ipar)
{
    ...
    extern /* Subroutine */ int dscal_(integer *, doublereal *, doublereal *, 
	    ...
	    *, integer *);
    integer meband;
    extern /* Subroutine */ int dacopy_(integer *, integer *, doublereal *, 
	    integer *, doublereal *, integer *);
    extern doublereal dvnorm_(integer *, doublereal *, doublereal *);
...
/* L250: */
	...
	++dvod02_1.nlu;
	dgefa_(&wm[3], &dvod01_1.n, &dvod01_1.n, &iwm[31], &ier);
	if (ier != 0) {
	    *ierpj = 1;
	}
	return 0;
...
/* L580: */
    ...
    ++dvod02_1.nlu;
    dgbfa_(&wm[3], &meband, &dvod01_1.n, &ml, &mu, &iwm[31], &ier);
    if (ier != 0) {
	*ierpj = 1;
    }
    return 0;
...
L100:
    dgesl_(&wm[3], &dvod01_1.n, &dvod01_1.n, &iwm[31], &x[1], &c__0);
    return 0;
...
L400:
    ...
    mu = iwm[2];
    meband = (ml << 1) + mu + 1;
    dgbsl_(&wm[3], &meband, &dvod01_1.n, &ml, &mu, &iwm[31], &x[1], &c__0);
    return 0;
	...
	doublereal *r1, doublereal *r2, ftnlen msg_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___232 = { 0, 0, 0, fmt_10, 0 };
    static cilist io___233 = { 0, 0, 0, fmt_20, 0 };
    static cilist io___234 = { 0, 0, 0, fmt_30, 0 };
    static cilist io___235 = { 0, 0, 0, fmt_40, 0 };
    static cilist io___236 = { 0, 0, 0, fmt_50, 0 };
