/* zchud.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int zchud_(doublecomplex *r__, integer *ldr, integer *p, 
...
/*     dsqrt(rho**2 + zeta**2).  zchud will simultaneously update */
...
/*     zchud uses the following functions and subroutines. */

/*     extended blas zrotg */
/*     fortran dconjg,dsqrt */
...
/*        compute the next rotation. */
	...
	zrotg_(&r__[j + j * r_dim1], &xj, &c__[j], &s[j]);
/* L30: */
    }
