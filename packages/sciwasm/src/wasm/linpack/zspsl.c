/* zspsl.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int zspsl_(doublecomplex *ap, integer *n, integer *kpvt, 
	doublecomplex *b)
{
...
/*     a * x = b */
/*     using the factors computed by zspfa. */
...
/*        a division by zero may occur if  zspco  has set rcond .eq. 0.0 */
...
/*              apply the transformation. */
    ...
    i__1 = k - 1;
    zaxpy_(&i__1, &b[k], &ap[ik + 1], &c__1, &b[1], &c__1);
L30:
...
/*              apply the transformation. */
    ...
    zaxpy_(&i__1, &b[k], &ap[ik + 1], &c__1, &b[1], &c__1);
    i__1 = k - 2;
    zaxpy_(&i__1, &b[k - 1], &ap[ikm1 + 1], &c__1, &b[1], &c__1);
L60:
...
/*              apply the transformation. */
    ...
    i__2 = k;
    i__3 = k - 1;
    zdotu_(&z__2, &i__3, &ap[ik + 1], &c__1, &b[1], &c__1);
...
/*              apply the transformation. */
    ...
    i__2 = k + 1;
    i__3 = k - 1;
    zdotu_(&z__2, &i__3, &ap[ikp1 + 1], &c__1, &b[1], &c__1);
    z__1.r = b[i__2].r + z__2.r, z__1.i = b[i__2].i + z__2.i;
    b[i__1].r = z__1.r, b[i__1].i = z__1.i;
    kp = (i__1 = kpvt[k], abs(i__1));
    if (kp == k) {
