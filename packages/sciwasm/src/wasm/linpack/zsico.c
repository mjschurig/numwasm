/* zsico.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int zsico_(doublecomplex *a, integer *lda, integer *n, 
...
/*     zsico factors a complex*16 symmetric matrix by elimination with */
...
/*     factor */
    ...
    zsifa_(&a[a_offset], lda, n, &kpvt[1], &info);
...
L70:
    ...
    i__1 = k - ks;
    zaxpy_(&i__1, &z__[k], &a[k * a_dim1 + 1], &c__1, &z__[1], &c__1);
    if (ks == 1) {
	goto L80;
    }
    i__1 = k - 1;
    ...
    z__[i__1].r = z__1.r, z__[i__1].i = z__1.i;
    i__1 = k - ks;
    zaxpy_(&i__1, &z__[k - 1], &a[(k - 1) * a_dim1 + 1], &c__1, &z__[1], &
	    c__1);
L80:
    if (ks == 2) {
	goto L100;
    ...
    i__3 = k + k * a_dim1;
    i__4 = k + k * a_dim1;
    z__2.r = a[i__4].r * 0. - a[i__4].i * -1., z__2.i = a[i__4].i * 0. + a[
	    i__4].r * -1.;
...
L130:
    ...
    i__2 = k;
    i__3 = k - 1;
    zdotu_(&z__2, &i__3, &a[k * a_dim1 + 1], &c__1, &z__[1], &c__1);
	...
	i__2 = k + 1;
	i__3 = k - 1;
	zdotu_(&z__2, &i__3, &a[(k + 1) * a_dim1 + 1], &c__1, &z__[1], &c__1);
	z__1.r = z__[i__2].r + z__2.r, z__1.i = z__[i__2].i + z__2.i;
	z__[i__1].r = z__1.r, z__[i__1].i = z__1.i;
    }
    kp = (i__1 = kpvt[k], abs(i__1));
