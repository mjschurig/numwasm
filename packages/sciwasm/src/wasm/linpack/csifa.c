/* csifa.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int csifa_(complex *a, integer *lda, integer *n, integer *
	kpvt, integer *info)
{
...
/*     fortran abs,aimag,amax1,real,sqrt */
...
/*           perform the elimination. */
	...
	c_div(&q__1, &a[j + (k - 1) * a_dim1], &a[k - 1 + k * a_dim1]);
