/* zppco.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int zppco_(doublecomplex *ap, integer *n, doublereal *rcond, 
	doublecomplex *z__, integer *info)
{
    ...
    doublecomplex wkm;
    doublereal anorm;
    extern /* Subroutine */ int zppfa_(doublecomplex *, integer *, integer *);
...
/*     zppco factors a complex*16 hermitian positive definite matrix */
...
/* L50: */
	...
	z__3.r = z__1.r * 0. - z__1.i * -1., z__3.i = z__1.i * 0. + z__1.r * 
		-1.;
	i__3 = kk;
	if ((d__1 = z__1.r, abs(d__1)) + (d__2 = z__3.r, abs(d__2)) <= ap[
		i__3].r) {
	    goto L60;
	}
	i__2 = k;
	...
	z__3.r = z__1.r * 0. - z__1.i * -1., z__3.i = z__1.i * 0. + z__1.r * 
		-1.;
	s = ap[i__3].r / ((d__1 = z__1.r, abs(d__1)) + (d__2 = z__3.r, abs(
		d__2)));
...
/*        solve r*y = w */
	...
	z__1.r = z__[i__4].r * 0. - z__[i__4].i * -1., z__1.i = z__[i__4].i * 
		0. + z__[i__4].r * -1.;
	s = ap[i__2].r / ((d__1 = z__[i__3].r, abs(d__1)) + (d__2 = z__1.r, 
		abs(d__2)));
	zdscal_(n, &s, &z__[1], &c__1);
L120:
	i__2 = k;
	...
	t.r = z__1.r, t.i = z__1.i;
	i__2 = k - 1;
	zaxpy_(&i__2, &t, &ap[kk + 1], &c__1, &z__[1], &c__1);
/* L130: */
    }
    s = 1. / dzasum_(n, &z__[1], &c__1);
    zdscal_(n, &s, &z__[1], &c__1);
...
/*        solve ctrans(r)*v = y */
	...
	i__3 = k;
	i__4 = k - 1;
	zdotc_(&z__2, &i__4, &ap[kk + 1], &c__1, &z__[1], &c__1);
