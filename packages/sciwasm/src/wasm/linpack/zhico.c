/* zhico.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int zhico_(doublecomplex *a, integer *lda, integer *n, 
...
/*     factor */
    ...
    zhifa_(&a[a_offset], lda, n, &kpvt[1], &info);
...
L130:
    ...
    i__2 = k;
    i__3 = k - 1;
    zdotc_(&z__2, &i__3, &a[k * a_dim1 + 1], &c__1, &z__[1], &c__1);
	...
	i__2 = k + 1;
	i__3 = k - 1;
	zdotc_(&z__2, &i__3, &a[(k + 1) * a_dim1 + 1], &c__1, &z__[1], &c__1);
	z__1.r = z__[i__2].r + z__2.r, z__1.i = z__[i__2].i + z__2.i;
	z__[i__1].r = z__1.r, z__[i__1].i = z__1.i;
    }
    kp = (i__1 = kpvt[k], abs(i__1));
