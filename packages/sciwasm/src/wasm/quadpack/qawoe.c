/* qawoe.f -- translated by f2c (version 20240504).
	...
	elist, integer *iord, integer *nnlog, integer *momcom, real *chebmo)
{
    ...
    real dres;
    integer ksgn, nres;
    real area1, area2, area12, small, erro12, defab1, defab2, width;
    integer ierro;
    real oflow;
    integer ktmin, nrmax, nrmom;
    real uflow;
    logical noext;
    ...
    integer numrl2;
    real defabs, domega, epmach, erlarg, abseps, correc, errbnd, resabs;
    integer jupbnd;
    logical extall;
    real erlast, errmax;
    integer maxerr;
