/* qawf.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int qawf_(E_fp f, real *a, real *omega, integer *integr, 
	real *epsabs, real *result, real *abserr, integer *neval, integer *
	ier, integer *limlst, integer *lst, integer *leniw, integer *maxp1, 
	integer *lenw, integer *iwork, real *work)
{
    integer l1, l2, l3, l4, l5, l6, ll2, lvl, last;
    extern /* Subroutine */ int qawfe_(E_fp, real *, real *, integer *, real *
...
/*         prepare call for qawfe */
    ...
    l6 = limit + l5;
    ll2 = limit + l1;
    qawfe_((E_fp)f, a, omega, integr, epsabs, limlst, &limit, maxp1, result, 
...
L10:
    ...
    if (*ier != 0) {
	xerror_("abnormal return from  qawf", &c__26, ier, &lvl, (ftnlen)26);
    }
    return 0;
} /* qawf_ */
