/* qag.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int qag_(E_fp f, real *a, real *b, real *epsabs, real *
	...
	iwork, real *work)
{
    ...
    extern /* Subroutine */ int qage_(E_fp, real *, real *, real *, real *, 
	    integer *, integer *, real *, real *, integer *, integer *, real *
	    , real *, real *, real *, integer *, integer *), xerror_(char *, 
...
/*         prepare call for qage. */
    ...
    qage_((E_fp)f, a, b, epsabs, epsrel, key, limit, result, abserr, neval, 
...
L10:
    ...
    if (*ier != 0) {
	xerror_("abnormal return from  qag ", &c__26, ier, &lvl, (ftnlen)26);
    }
    return 0;
} /* qag_ */
