/* dqc25f.f -- translated by f2c (version 20240504).
	...
	chebmo)
{
    ...
    doublereal d__[25];
    integer i__, j, k, m;
    doublereal v[28], d1[25], d2[25], p2, p3, p4, ac, an, as, an2, ass, par2, 
	    conc, asap, par22, fval[25], estc, cons;
    integer iers;
    doublereal ests;
    integer isym, noeq1;
    doublereal cheb12[13], cheb24[25], resc12, resc24, hlgth, centr;
