/* qc25f.f -- translated by f2c (version 20240504).
	...
	momcom, real *chebmo)
{
    ...
    real d__[25];
    integer i__, j, k, m;
    real v[28], d1[25], d2[25], p2, p3, p4, ac, an, as, an2, ass, par2, conc, 
...
/* L140: */
	...
	*resabs = *resabs + (r__1 = cheb24[k - 1], dabs(r__1)) + (r__2 = 
		cheb24[k], dabs(r__2));
	k += -2;
/* L150: */
    }
