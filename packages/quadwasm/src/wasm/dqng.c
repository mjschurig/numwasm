/* dqng.f -- translated by f2c (version 20240504).
	...
	integer *neval, integer *ier)
{
    ...
    integer ipx;
    doublereal absc, fval, res10, res21, res43, res87, fval1, fval2, hlgth, 
	    centr, reskh, uflow;
    extern doublereal d1mach_(integer *);
    doublereal epmach, dhlgth, resabs, resasc, fcentr, savfun[21];
