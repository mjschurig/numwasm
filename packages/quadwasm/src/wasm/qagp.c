/* qagp.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int qagp_(E_fp f, real *a, real *b, integer *npts2, real *
	points, real *epsabs, real *epsrel, real *result, real *abserr, 
	integer *neval, integer *ier, integer *leniw, integer *lenw, integer *
	last, integer *iwork, real *work)
{
    integer l1, l2, l3, l4, lvl;
    extern /* Subroutine */ int qagpe_(E_fp, real *, real *, integer *, real *
...
/*         prepare call for qagpe. */
    ...
    qagpe_((E_fp)f, a, b, npts2, &points[1], epsabs, epsrel, &limit, result, 
...
L10:
    ...
    if (*ier != 0) {
	xerror_("abnormal return from  qagp", &c__26, ier, &lvl, (ftnlen)26);
    }
    return 0;
} /* qagp_ */
