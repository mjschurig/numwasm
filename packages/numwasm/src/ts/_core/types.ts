...
export interface WasmModule {
  ...
  _ndarray_arange(start: number, stop: number, step: number, dtype: number): number;
  _ndarray_linspace(start: number, stop: number, num: number, endpoint: number, dtype: number): number;
  _ndarray_eye(N: number, M: number, k: number, dtype: number): number;
  _ndarray_tri(N: number, M: number, k: number, dtype: number): number;
  _ndarray_tril(ptr: number, k: number): number;
  _ndarray_triu(ptr: number, k: number): number;
  _ndarray_vander(ptr: number, N: number, increasing: number): number;
  _ndarray_free(ptr: number): void;
  _ndarray_copy(ptr: number): number;
  _ndarray_copyto(dstPtr: number, srcPtr: number, wherePtr: number): number;
