...
import { broadcastArrays } from "../_core/broadcast.js";
import { extract } from "../indexing.js";
import { Slice, type IndexElement } from "../_core/slice.js";
...
function storeResult(
  ...
  if (isScalar) {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      const resultIndices = unravelIndex(
        i,
        output.shape.slice(_axis, _axis + resultNdim),
      );
