/* zchex.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int zchex_(doublecomplex *r__, integer *ldr, integer *p, 
...
/*     zchex uses the following functions and subroutines. */
...
/*        calculate the rotations. */
    ...
    i__1 = lmk;
    for (i__ = 1; i__ <= i__1; ++i__) {
	zrotg_(&s[i__ + 1], &t, &c__[i__], &s[i__]);
	i__2 = i__ + 1;
...
L200:
	...
	i__2 = jj;
	t.r = s[i__2].r, t.i = s[i__2].i;
	zrotg_(&r__[j + j * r_dim1], &t, &c__[jj], &s[jj]);
L210:
/* L220: */
	;
    }
