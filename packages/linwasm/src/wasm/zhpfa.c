/* zhpfa.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int zhpfa_(doublecomplex *ap, integer *n, integer *kpvt, 
	integer *info)
{
...
/*     zhpfa factors a complex*16 hermitian matrix stored in */
...
/*                     but it does indicate that zhpsl or zhpdi may */
