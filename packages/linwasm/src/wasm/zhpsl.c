/* zhpsl.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int zhpsl_(doublecomplex *ap, integer *n, integer *kpvt, 
	doublecomplex *b)
{
...
/*     a * x = b */
/*     using the factors computed by zhpfa. */
...
/*        a division by zero may occur if  zhpco  has set rcond .eq. 0.0 */
...
/*              apply the transformation. */
    ...
    i__2 = k;
    i__3 = k - 1;
    zdotc_(&z__2, &i__3, &ap[ik + 1], &c__1, &b[1], &c__1);
...
/*              apply the transformation. */
    ...
    i__2 = k + 1;
    i__3 = k - 1;
    zdotc_(&z__2, &i__3, &ap[ikp1 + 1], &c__1, &b[1], &c__1);
    z__1.r = b[i__2].r + z__2.r, z__1.i = b[i__2].i + z__2.i;
    b[i__1].r = z__1.r, b[i__1].i = z__1.i;
    kp = (i__1 = kpvt[k], abs(i__1));
    if (kp == k) {
