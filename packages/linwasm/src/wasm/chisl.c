/* chisl.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int chisl_(complex *a, integer *lda, integer *n, integer *
	kpvt, complex *b)
{
...
/*              apply the transformation. */
    ...
    i__2 = k;
    i__3 = k - 1;
    cdotc_(&q__2, &i__3, &a[k * a_dim1 + 1], &c__1, &b[1], &c__1);
...
/*              apply the transformation. */
    ...
    i__2 = k + 1;
    i__3 = k - 1;
    cdotc_(&q__2, &i__3, &a[(k + 1) * a_dim1 + 1], &c__1, &b[1], &c__1);
    q__1.r = b[i__2].r + q__2.r, q__1.i = b[i__2].i + q__2.i;
    b[i__1].r = q__1.r, b[i__1].i = q__1.i;
    kp = (i__1 = kpvt[k], abs(i__1));
    if (kp == k) {
