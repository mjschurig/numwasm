/* chpco.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int chpco_(complex *ap, integer *n, integer *kpvt, real *
	rcond, complex *z__)
{
    ...
    extern /* Subroutine */ int chpfa_(complex *, integer *, integer *, 
	    integer *);
...
L130:
    ...
    i__2 = k;
    i__3 = k - 1;
    cdotc_(&q__2, &i__3, &ap[ik + 1], &c__1, &z__[1], &c__1);
	...
	i__2 = k + 1;
	i__3 = k - 1;
	cdotc_(&q__2, &i__3, &ap[ikp1 + 1], &c__1, &z__[1], &c__1);
	q__1.r = z__[i__2].r + q__2.r, q__1.i = z__[i__2].i + q__2.i;
	z__[i__1].r = q__1.r, z__[i__1].i = q__1.i;
    }
    kp = (i__1 = kpvt[k], abs(i__1));
