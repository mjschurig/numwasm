...
export default function MatrixDemo() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-8 text-gray-100">
      <h1 className="text-3xl font-bold mb-4">Matrix Multiplication Demo</h1>
      ...
      <div className="text-center mb-8">
        <Button
          ...
          className="cta-button px-6 py-3 rounded-lg font-semibold text-primary hover:text-white pressed:scale-95 transition-all cursor-pointer"
        >
      ...
      {matrices && (
        <div className="flex items-center justify-center gap-4 flex-wrap my-8">
          ...
          <span className="text-3xl font-bold text-gray-500">&times;</span>
      ...
      {matrices && (
        <div className="mt-8 p-6 bg-gray-800/50 border border-gray-700/50 rounded-lg backdrop-blur-sm">
          ...
          <pre className="text-sm bg-gray-900/50 border border-gray-700/50 p-4 rounded-lg overflow-x-auto">
